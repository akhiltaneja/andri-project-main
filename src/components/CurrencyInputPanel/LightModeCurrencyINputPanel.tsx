        ...
        <RowBetween>
          {!hideInput && (
            <DetailArea style={hideInput ? { padding: '0', borderRadius: '8px' } : {}} selected={disableCurrencySelect}>
              ...
              <NumericalInput
                className="token-amount-input white-mode-input-currency-text-style"
                value={value}
                onUserInput={(val) => {
                  onUserInput(val)
                }}
            ...
            {!hideInput && (
              <>
                {account && currency && showMaxButton && label !== 'To' && (
                  <Button onClick={onMax} size="sm" variant="text" className="hidend-button-wallet-custome-style-new">
                    Max
                  </Button>
                )}
              </>
